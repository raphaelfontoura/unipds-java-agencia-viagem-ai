...
```bash
curl -X POST -H "Content-Type: text/plain" -d "Estou planejando uma viagem para o Japao. Qual a melhor epoca do ano para visitar e porque? Responda em portugues." http://localhost:8080/travel
```
...
public interface PackageExpertWithTemplate {
    ...
    @SystemMessage("""
            ...
            Sua principal responsabilidade é responder as perguntas dos clientes de forma amigável e precisa,
    ...
    @InputGuardrails(value = {InjectionGuard.class})
    @OutputGuardrails(value = {ToneGuardrail.class}, maxRetries = 2)

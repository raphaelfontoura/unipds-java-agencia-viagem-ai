...
public class BookingTools {
    ...
    @Tool(
            ...
            value = "Obtém os detalhes de uma reserva com base em seu número de identificação (bookingId). " +
    ...
    @Tool(
            name = "cancel_booking",
            value = "Cancela uma reserva com base em seu número de identificação (bookingId) e no sobrenome do cliente (customerLastName). " +
